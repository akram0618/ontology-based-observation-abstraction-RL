...
class Simulator:
    ...
    def from_json(cls, conf_file):
        ...
        weather.temperatures.loc[indices_to_replace, column_to_replace] = weather.temperatures.loc[indices_to_replace, column_to_replace] * 10
    ...
    def get_concated_features(self):
        ...
        if rand_noise == 1:
            previous_outside_temperatures = None'''
